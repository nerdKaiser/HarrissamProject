...
?>
  ...
  <input type="hidden" name="currnt_date" class="form-control" value="<?php echo $currnt_date;?>">
     ...
     <input type="text" name="sname" class="form-control" placeholder="service name" id="event" onkeydown="return alphaOnly(event);" required="">
         ...
         <div class="form-group">
                             <div class="row">
             <label class="col-sm-3 control-label">Cost(kshs)</label>
                                <div class="col-sm-9">
             <input type="text" name="prize" class="form-control" placeholder="Prices" id="tbprize"   onkeypress="javascript:return isNumber(event)" required="">
                         </div>
                     </div>
                                        </div>
                 </div>
