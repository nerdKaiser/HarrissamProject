...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT * FROM request where client_id='$client_id' and (engineer='Completed' or manager='Job Done') order by up_date desc";
    ...
    if (mysqli_num_rows($response) > 0) {
        ...
        $results['trust'] = 0;
        $results['mine'] = "No Room For Feedback. Please check from your Request History.";
