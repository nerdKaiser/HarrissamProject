...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT * FROM request where client_id='$client_id' and mgrstatus='Approved' and clistatus='Pending' order by reg_date desc";
    ...
    if (mysqli_num_rows($response) > 0) {
        ...
        $results['trust'] = 0;
        $results['mine'] = "You do not have Any Confirmed Request";
